            ...
            <div class="col-md-2 mb-2 mr-4 align-items-center">
                <div class="row align-items-center">
                    <picture class="mx-auto my-auto">
                        <source media="(max-width: 768px)" srcset="{{ asset('storage/uinsgd-logo.png') }}"
                            style="height: auto; max-width: 10%;">
                        <img src="{{ asset('storage/uin-bandung-logo.png') }}" alt="Logo UIN Sunan Gunung Djati Bandung"
