...
@section('detail-form')
    ...
    <div class="form-group">
        ...
        <input required id="pembimbing_studi" name="pembimbing_studi" type="text" class="form-control" placeholder="Contoh: Dr. Mikial Ramdan., M.Si." data-toggle="tooltip" title="Masukkan nama dosen pembimbing studi beserta gelar akademisnya." data-placement="top">
