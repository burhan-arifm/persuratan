...
@section('detail-form')
    ...
    <div class="form-group">
        ...
        <textarea required class="form-control" id="alamat_instansi" name="alamat_instansi" placeholder="Contoh: Jl.A.H Nasution No.05" rows="3" data-toggle="tooltip" title="Masukkan alamat instansi tempat pelaksanaan" data-placement="top">{{ $surat->izin_praktik->alamat_instansi }}</textarea>
        <div class="invalid-feedback">
			Wajib diisi.
		</div>
    </div>
