    ...
    <div class="row my-3">
        ...
        <div class="col-10">
            ...
            <div class="row">
                <p>
                    Kepada Yth.<br>
                    <b>{{ $surat->job_training->instansi_penerima }}</b><br>
                    {{ $surat->job_training->alamat_instansi }}<br>
            ...
            <div class="row mt-1">
                ...
                <table class="table table-sm table-borderless" style="margin-left: 2.2em;">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>{{ $surat->job_training->dosen_pembimbing }}</td>
                        </tr>
                    </tbody>
                </table>
                <!-- end of Isi Surat -->
                ...
                <p class="text-justify mini-margin">
                    untuk melaksanakan <b><em>Persiapan Pelaksanaan Job Training</em></b> di Lembaga yang Bapak/ Ibu/ Saudara pimpin.
                </p>
