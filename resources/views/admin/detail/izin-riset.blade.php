    ...
    <div class="col-10">
        ...
        <div class="row mt-1">
            ...
            <p class="text-justify mini-margin">
                untuk mengadakan Riset / Survey / Konsultasi pada Instansi / Lembaga yang Bapak / Ibu / Saudara pimpin
                dalam rangka penyusunan skripsi yang berjudul "{{ $surat->izin_riset->judul_skripsi }}". <br>
                Dosen Pembimbing: <br>
