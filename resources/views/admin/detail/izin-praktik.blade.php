    ...
    <div class="col-10">
        ...
        <div class="row mt-1">
            ...
            <p class="text-justify mini-margin">
                untuk melaksanakan praktik mata kuliah dalam mata kuliah {{ $surat->izin_praktik->mata_kuliah }} dengan
                dosen pengampu mata kuliah {{ $surat->izin_praktik->dosen_pengampu }}.
            </p>
